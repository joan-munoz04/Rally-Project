...
const EventCard = ({ date, location, categories }: EventCardProps) => {
    return (
        <div className="border-2 rounded-2xl border-gray-300 w-full p-5 flex flex-row justify-between items-center">
            ...
            <Button text="Ver más" icon="mdi:arrow-right-bold" color="lOrange" iconPosition="right" size="small"></Button>
        </div>
    )
}
